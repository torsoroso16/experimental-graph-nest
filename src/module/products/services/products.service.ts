...
import categoryWiseProductSaleJson from '../category-wise-products-sale.json';
import lowStockProductsJson from '../low-stock-products.json';
import topRatedProductJson from '../top-rated-products.json';

const products: Product[] = plainToInstance(Product, productsJson as object[]);
const bestSellingProducts: Product[] = plainToInstance(Product, bestSellingProductsJson as object[]);
const categoryWiseProducts: CategoryWiseProduct[] = plainToInstance(CategoryWiseProduct, categoryWiseProductJson as object[]);
const categoryWiseProductsSale: CategoryWiseProductSale[] = plainToInstance(CategoryWiseProductSale, categoryWiseProductSaleJson as object[]);
const lowStockProducts: Product[] = plainToInstance(Product, lowStockProductsJson as object[]);
const topRatedProduct: TopRatedProduct[] = plainToInstance(TopRatedProduct, topRatedProductJson as object[]);
