...
export class AuthorsResolver {
  ...
  @Query(() => [Author])
  async topAuthors(
    @Args() getTopAuthorArgs: GetTopAuthorArgs,
  ): Promise<Author[]> {
    return this.authorsService.topAuthors(getTopAuthorArgs.limit);
  }
}
