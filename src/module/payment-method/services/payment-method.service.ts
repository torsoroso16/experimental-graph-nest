...
import { UsersService as AuthService } from 'src/module/users/services/users.service';
import { StripeCustomer, StripePaymentMethod } from 'src/module/payment/entity/stripe.entity';
import { Settings } from 'src/module/settings/entities/setting.entity';
import { SettingsService } from 'src/module/settings/services/settings.service';
...
const paymentMethods = plainToInstance(Card, cards as object[]);
...
export class PaymentMethodService {
  ...
  private setting: Settings; // Inisialisasi di sini, bukan di tempat lain
  ...
  constructor(
    ...
    // Inisialisasi setting *setelah* settingService siap
