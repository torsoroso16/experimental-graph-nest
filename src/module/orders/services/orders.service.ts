...
import { StripePaymentService } from 'src/module/payment/services/stripe-payment.service';
import { PaypalPaymentService } from 'src/module/payment/services/paypal-payment.service';
import settingJson from 'src/module/settings/settings.json';
import paymentIntentJson from 'src/module/payment-intent/payment-intent.json';
...
const orders = plainToInstance(Order, ordersJson as object[]);
const orderStatus = plainToInstance(OrderStatus, orderStatusJson as object[]);
const orderFiles = plainToInstance(OrderFiles, orderFilesJson as object[]);
const settings = plainToInstance(Settings, settingJson);
